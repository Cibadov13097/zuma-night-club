...
const MapSection = () => {
  // Coordinates for the map - easily changeable
  const lat = "-26.2041";
  const lng = "28.0473";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative aspect-video md:aspect-[21/9] w-full">
            <iframe
              src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3579.1234567890123!2d${lng}!3d${lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDEyJzE0LjgiUyAyOMKwMDInNTAuMyJF!5e0!3m2!1sen!2s!4v1234567890123!5m2!1sen!2s`}
              width="100%"
              height="100%"
